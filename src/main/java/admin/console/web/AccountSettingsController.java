...
public class AccountSettingsController {
    ...
    @RequestMapping
    public String index(@CurrentUser User user, Model model, AccountSettingsUpdateThemeForm form) {
    ...
    public String updateTheme(@CurrentUser User user, Model model, @Validated AccountSettingsUpdateThemeForm form, BindingResult bindingResult) {
